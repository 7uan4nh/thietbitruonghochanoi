document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_kythuat");
    let linkThietBiAside = document.getElementById("tieuhoc_kythuat-aside");
