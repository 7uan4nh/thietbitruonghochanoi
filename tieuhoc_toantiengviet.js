document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_toantiengviet");
    let linkThietBiAside = document.getElementById("tieuhoc_toantiengviet-aside");
    ...
    if (linkThietBiNav) {
        linkThietBiNav.addEventListener("click", function (event) {
            ...
            openPage("tieuhoc_toantiengviet.html");
        });
    }
