document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("noithat_banghe");
    let linkThietBiAside = document.getElementById("noithat_banghe-aside");
