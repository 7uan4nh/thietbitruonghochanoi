document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_amnhac");
    let linkThietBiAside = document.getElementById("tieuhoc_amnhac-aside");
