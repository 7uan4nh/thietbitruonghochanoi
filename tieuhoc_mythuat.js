document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_mythuat");
    let linkThietBiAside = document.getElementById("tieuhoc_mythuat-aside");
