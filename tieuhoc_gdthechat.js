document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_gdthechat");
    let linkThietBiAside = document.getElementById("tieuhoc_gdthechat-aside");
    ...
    if (linkThietBiNav) {
        linkThietBiNav.addEventListener("click", function (event) {
            ...
            openPage("tieuhoc_gdthechat.html");
        });
    }
