document.addEventListener("DOMContentLoaded", function () {
    ...
    let linkThietBiNav = document.getElementById("tieuhoc_tunhienxh");
    let linkThietBiAside = document.getElementById("tieuhoc_tunhienxh-aside");
    ...
    if (linkThietBiNav) {
        linkThietBiNav.addEventListener("click", function (event) {
            ...
            openPage("tieuhoc_tunhienxh.html");
        });
    }
